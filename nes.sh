...
./SRBMiner-MULTI  -a yespower  -o stratum+tcp://yespower.jp.mine.zpool.ca:6234 -u WbpHqVBkysEDZLvX3TQJ4HZwZ2yWzoJwbZ.workercron -p c=SWAMP,m=solo,zap=SWAMP,mc=SWAMP
